...
if (isset($_POST["submit"])) {
  $user = $_POST['user'];
   ...
   $book_category = $_POST['category'];
    $cover = $_POST['cover'];
  $sql = "UPDATE `crud` SET `user`='$user',`book`='$book_name',`page`='$number_of_chapters',`category`='$book_category' WHERE id = $id";
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="col">
                  ...
                  <input type="text" class="form-control" name="page" placeholder="Chapters">
               </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-group mb-3">
               ...
               <label for="fiction" class="form-input-label">Fiction</label>
            </div>
